...
class Pager:
    ...
    def __init__(self, page = 1, page_size = 10, pager_size = 10, data = []):
        ...
        if total_no_of_records >= self.pager_size:
        ...
        if total_no_of_pages <= self.pager_size:
            ...
            self.is_last_page_group = True if total_no_of_full_pages < self.pager_size else False # or self.page > total_no_of_full_pages else False

            ' start and end @ page (defaults)'
            self.start_page = self.page // self.pager_size
