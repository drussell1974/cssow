...
def _update(db, model, published):
    str_update = "UPDATE sow_learning_episode SET order_of_delivery_id = {order_of_delivery_id}, scheme_of_work_id = {scheme_of_work_id}, topic_id = {topic_id}, published = {published} WHERE id =  {learning_episode_id};"
...
def _insert(db, model, published):
    str_insert = "INSERT INTO sow_learning_episode (order_of_delivery_id, scheme_of_work_id, topic_id, created, created_by, published) VALUES ({order_of_delivery_id}, {scheme_of_work_id}, {topic_id}, '{created}', {created_by}, {published});"
