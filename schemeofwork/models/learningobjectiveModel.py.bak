...
class LearningObjectiveModel (BaseModel):
    ...
    def _insert(this):
        ...
        learning_objective_id = this.get_last_insert_row_id(db)

        # TODO: insert linking table between objective and learning episode

        str_insert2 = "INSERT INTO sow_learning_objective__has__learning_episode (learning_objective_id, learning_episode_id) VALUES ({}, {});"
        str_insert2 = str_insert2.format(learning_objective_id, this.learning_episode_id)
