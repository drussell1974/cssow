...
routes_in == {
    ...
    # don't break appadmin
    ('/$app/appadmin', '/$app/appadmin'),
    ('/$app/appadmin/$anything', '/$app/appadmin/$anything')
    # map specific urls
    ## schemesofwork
    ('/$app/schemesofwork/', '/$app/schemesofwork/'),
    ('/$app/schemesofwork/$anything', '/$app/schemesofwork/$anything'),
    ## learning episodes
    ('/$app/learningepisode/', '/$app/learningepisode/'),
    ('/$app/learningepisode/$anything', '/$app/learningepisode/$anything')
}
