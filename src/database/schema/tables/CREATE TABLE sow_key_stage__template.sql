...
INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('11', '5', 'KS1', '0', '0');
INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('12', '5', 'KS2', '0', '0');
INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('13', '5', 'KS3', '0', '0');

INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('14', '6', 'KS1', '0', '0');
INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('15', '6', 'KS2', '0', '0');
INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('16', '6', 'KS3', '0', '0');
INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('17', '6', 'KS4', '0', '0');
INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('18', '6', 'KS5', '0', '0');
-- DELETE FROM `sow_pathway_template_key_stages` WHERE (`id` = '5');

INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('19', '4', 'KS1', '0', '0');
INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('20', '4', 'KS2', '0', '0');
INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('21', '4', 'KS3', '0', '0');
INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('22', '4', 'KS4', '0', '0');
INSERT INTO `sow_pathway_template_key_stages` (`id`, `pathway_template_id`, `name`, `created_by`, `modified_by`) VALUES ('23', '4', 'KS5', '0', '0');



ALTER TABLE `drussell1974$cssow_api`.`sow_pathway_template_key_stages` 
ADD INDEX `cssow_pathway_template_key_stages__has__pathway_template` (`pathway_template_id` ASC) VISIBLE;
;
ALTER TABLE `drussell1974$cssow_api`.`sow_pathway_template_key_stages` 
