...
ADD INDEX `fk_sow_content__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_content__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_cs_concept__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_cs_concept__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_department__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_department__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_exam_board__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_exam_board__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_institute__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_institute__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_key_stage__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_ssow_key_stage__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_key_word__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_key_word__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_ks123_pathway__has__created_by_user_idx` (`created_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_learning_objective__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_learning_objective__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_lesson__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_lesson__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_menu__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_menu__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_play_based__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_play_based__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_resource__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_resource__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_resource_type__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_resource_type__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_scheme_of_work__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_scheme_of_work__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_solo_taxonomy__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_solo_taxonomy__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_subject_purpose__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_subject_purpose__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;
...
ADD INDEX `fk_sow_year__has__created_by_user_idx` (`created_by` ASC) VISIBLE,
ADD INDEX `fk_sow_year__has__modified_by_user_idx` (`modified_by` ASC) VISIBLE;