...
DROP PROCEDURE IF EXISTS scheme_of_work__get_team_permissions$2;

CREATE PROCEDURE scheme_of_work__get_team_permissions$2 (
 IN p_head_id INT,
...
CALL scheme_of_work__get_team_permissions$2(2,5,2,True,2);
