...
DROP PROCEDURE IF EXISTS scheme_of_work__get_my$2;

CREATE PROCEDURE scheme_of_work__get_my$2 (	
...
BEGIN
    SELECT DISTINCT
      ...
      sow.study_duration as study_duration, -- 15
      sow.start_study_in_year as start_study_in_year -- 16
