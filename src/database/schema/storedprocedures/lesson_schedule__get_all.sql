...
DROP PROCEDURE IF EXISTS `lesson_schedule__get_all$3`;

CREATE PROCEDURE `lesson_schedule__get_all$3` 
(
 IN p_lesson_id INT,
...
// DELIMITER ;
CALL lesson_schedule__get_all$3(0, 0, 0, 2, '1700-04-04 00:00:00', '2121-12-31 23:59:59', 4, 2);
