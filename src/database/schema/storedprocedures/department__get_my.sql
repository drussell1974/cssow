...
DROP PROCEDURE IF EXISTS department__get_my$3;

CREATE PROCEDURE department__get_my$3 (
...
BEGIN
    ...
    FROM 
        ...
        LEFT JOIN sow_topic as top ON top.department_id = dep.id and parent_id is null
