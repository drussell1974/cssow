...
DROP PROCEDURE IF EXISTS scheme_of_work__get_team_permissions_by_join_code;

CREATE PROCEDURE scheme_of_work__get_team_permissions_by_join_code (
 IN p_join_code VARCHAR(8),
 -- IN p_head_id INT,
...
DELIMITER ;d
SELECT * FROM sow_teacher_join_code;
CALL `drussell1974$cssow_api`.`scheme_of_work__get_team_permissions_by_join_code`('EJNLVVVQ', False, 2);