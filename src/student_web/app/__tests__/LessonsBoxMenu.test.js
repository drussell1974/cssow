...
let lessons = [{
    ...
    number_of_learning_objectives: 3,
...
describe('LessonsBoxMenu', () => {
    ...
    it('has a multiple boxes', () => {
        ...
        expect(
            container.querySelectorAll('.box .disabled')
        ).toHaveLength(1);
    })
    ...
    it('renders coming soon disabled button when lesson has no resources and no learning objectives', () => {

        // update the values for the third item
        lessons[2].number_of_learning_objectives = 0
        lessons[2].number_of_resources = 0
