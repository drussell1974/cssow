...
#python -m unittest discover --start-directory ./tests/ui_test/ -p uitest_schemeofwork_schemesofwork_pages__public_permissions.py
#python -m unittest discover --start-directory ./tests/ui_test/ -p uitest_schemeofwork_schemesofworkkeyword_pages__public_permissions.py
python -m unittest discover --start-directory ./tests/ui_test/ -p uitest_schemeofwork_eventlog_pages__public_permissions.py
#python -m unittest discover --start-directory ./tests/ui_test/ -p uitest_schemeofwork_content_pages__public_permissions.py
...
#python -m unittest discover --start-directory ./tests/ui_test/ -p uitest_schemeofwork_lesson_pages__public_permissions.py
#python -m unittest discover --start-directory ./tests/ui_test/ -p uitest_schemeofwork_learningobjective_pages__public_permissions.py
#python -m unittest discover --start-directory ./tests/ui_test/ -p uitest_schemeofwork_lessonkeyword_pages__public_permissions.py
#python -m unittest discover --start-directory ./tests/ui_test/ -p uitest_schemeofwork_resources_pages__public_permissions.py
