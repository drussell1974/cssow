...
python -m unittest discover --start-directory ./tests/ui_test/ -p uitest_schemeofwork_learningobjective_pages__permissions_when_different_logged_in_users.py
python -m unittest discover --start-directory ./tests/ui_test/ -p uitest_schemeofwork_resources_pages__permissions_when_different_logged_in_users.py
