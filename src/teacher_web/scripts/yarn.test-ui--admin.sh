...
## start test
echo yarn test-ui--admin: Testing... uitest_schemeofwork_default_
...
## start test
echo yarn test-ui--admin: Testing... uitest_accounts_
...
## start test
echo yarn test-ui--admin: Testing... uitest_institute_*.py
...
## start test
echo yarn test-ui--admin: Testing... uitest_department_*.py
...
## start test
echo yarn test-ui--admin: running... uitest_schemeofwork_topic_*.py
python -m unittest discover --start-directory ./tests/ui_test/ -p uitest_schemeofwork_topic_*.py
# increment
x=$(($x+$?))
## end test
...
## start test
echo yarn test-ui--admin: running... uitest_schemeofwork_lessonschedule_*.py
