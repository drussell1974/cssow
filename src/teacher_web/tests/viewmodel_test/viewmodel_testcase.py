...
class ViewModelTestCase(TestCase):
    ...
    def assertViewModelContent(self, request, viewmodel, exp_page_prefix, exp_main_heading, exp_subheading, exp_validationerrors):

        actual = viewmodel.view(request).content
