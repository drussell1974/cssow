...
class test_viewmodel_IndexViewModel(TestCase):
    ...
    def test_init_called_fetch__single_row(self, mock_auth_user, InstituteModel_get_model):
        ...
        # arrange
        model = Model(56, "Lorum", topic_id=3, institute=InstituteModel(12767111276711, "Ipsum"))
    ...
    def test_init_called_fetch__multiple_rows(self, mock_auth_user, InstituteModel_get_model):
        ...
        data_to_return = [
            Model(56, "Tic", topic_id=3, institute=fake_institute),
            Model(57, "Tac", topic_id=2, institute=fake_institute),
            Model(58, "Toe", topic_id=1, institute=fake_institute)
        ]
