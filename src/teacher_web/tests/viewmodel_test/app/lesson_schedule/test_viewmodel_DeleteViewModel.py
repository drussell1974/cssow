...
class test_viewmodel_DeleteViewModel(TestCase):
    ...
    @patch.object(Model, "get_model", return_value=Model(101, class_name="", class_code="", start_date=None, lesson_id=23, scheme_of_work_id=34, is_from_db=True))
    ...
    @patch.object(Model, "get_model", return_value=Model(101, class_name="", class_code="", start_date=None, is_from_db=False, lesson_id=23, scheme_of_work_id=34))
    @patch.object(LessonModel, "get_model", return_value=LessonModel(34, title="", is_from_db=True))
