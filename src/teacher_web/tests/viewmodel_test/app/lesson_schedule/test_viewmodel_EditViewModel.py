...
class test_viewmodel_EditViewModel(TestCase):
    ...
    def test_view_when_existing(self, mock_auth_user):
        ...
        return_schedule_model = Model(101, class_name="7x", class_code="ABCDEF", start_date="2021-04-01 13:46:45", lesson_id=0, scheme_of_work_id=0, auth_user=mock_auth_user)
    ...
    def test_execute_called_save_when_valid(self, mock_auth_user):
        ...
        # mock saved object
        on_save__data_to_return = Model(101, class_name="", class_code="", start_date="", lesson_id=0, scheme_of_work_id=0, auth_user=mock_auth_user)
