...
class test_viewmodel_EditViewModel(TestCase):
    ...
    @patch.object(Model, "get_model", return_value=Model(24, "Jane Doe", SchemeOfWorkModel(22, "A-Level Computing")))
    def test_execute_should_call_save__when_model_is_valid(self, SchemeOfWorkModel_get_model, TeacherPermissionModel_get_model):
        ...
        with patch.object(Model, "save", return_value = SchemeOfWorkModel_get_model):
            ...
            test_context = ViewModel(db=self.mock_db, request=mock_request, scheme_of_work_id=22, teacher_id=6049, auth_user=99)
    ...
    @patch.object(SchemeOfWorkModel, "get_model", return_value=SchemeOfWorkModel(22, "A-Level Computing"))
    def test_execute_should_not_call_save__when_return_invalid(self, SchemeOfWorkModel_get_model):
        ...
        with patch.object(Model, "save", return_value=None):
            ...
            test_context = ViewModel(db=self.mock_db, request=mock_request, scheme_of_work_id=22, teacher_id=6059, auth_user=99)
            test_context.execute()
