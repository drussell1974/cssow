...
class test_SchemeOfWorkModel_validate__key_words(SchemeOfWork_TestCase):
    ...
    def test_max__invalid_extreme(self):
        ...
        self.assertEqual(test.validation_errors["key_words"], "has 1001 items (number of items cannot exceed 1000)")
