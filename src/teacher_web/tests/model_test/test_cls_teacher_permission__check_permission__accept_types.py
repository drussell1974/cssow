...
class test_cls_teacher_permission__check_permission__accept_types(TestCase):
    ...
    def setUp(self):
        ...
        self.test = Model(teacher_id=343434343, teacher_name="Tom foolery", join_code="ABCDEFGH",  scheme_of_work=SchemeOfWorkModel(11, name="KS3 Computing", study_duration=3, start_study_in_year=7), ctx=fake_ctx_model(),
