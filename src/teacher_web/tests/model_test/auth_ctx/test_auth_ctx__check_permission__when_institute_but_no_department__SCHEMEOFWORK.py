...
class test_auth_ctx__check_permission__when_institute_but_no_department__SCHEMEOFWORK(TestCase):

    def setUp(self):
       
        # arrange
        self.test = init_TestAuthCtx(institute_id=12767111276711, department_id=0, fake_request_user_id=6079)
    ...
    def test_should_return_false__when_user_is_authenticated__and__permissions_required__SCHEMEOFWORK_NONE(self):
