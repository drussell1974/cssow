...
class test_auth_ctx__check_permission__when_institute_and_department_exist__DEPARTMENT__visitor(TestCase):

    def setUp(self):
        
        # arrange
        self.test = init_TestAuthCtx(institute_id=12767111276711, department_id=67, fake_request_user_id=None)
