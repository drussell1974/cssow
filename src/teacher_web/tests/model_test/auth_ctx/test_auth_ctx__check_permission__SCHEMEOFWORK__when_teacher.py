...
class test_auth_ctx__check_permission__SCHEMEOFWORK__when_teacher(TestCase):
    ...
    def test_when_user_is_authenticated__no_permission_data(self):
        ...
        self.test = init_TestAuthCtx(institute_id=12767111276711, department_id=67, scheme_of_work_id=11, join_code="ABCDEFGH", fake_request_user_id=6079, fake_teacher_data=fake_teacher_data)
