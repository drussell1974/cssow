...
class test_auth_ctx__check_permission__when_no_institute_and_no_department__DEPARTMENT__visitor(TestCase):
    ...
    def test_should_return_false__when_user_is_authenticated_and__permissions_required__DEPARTMENT_NONE(self):
