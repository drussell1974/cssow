...
@patch.object(SchemeOfWorkModel, "get_my", return_value=[mock_scheme_of_work().__dict__])
@patch("shared.models.core.django_helper", return_value=fake_ctx_model())
class test_check_setup_and_notify__notify_schemeofwork_content(TestCase):
    ...
    def test__notify(self, mock_auth_ctx, mock_inst_getmy, mock_dep_getmy, mock_sow_getmy):
        ...
        with patch.object(SchemeOfWorkModel, "get_number_of_contents", return_value=0):
            with patch.object(NotifyModel, "create", return_value=None):
                ...
                # assert
                SchemeOfWorkModel.get_number_of_contents.assert_called()
