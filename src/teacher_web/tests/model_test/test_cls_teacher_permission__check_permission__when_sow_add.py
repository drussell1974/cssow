...
class test_cls_teacher_permission__check_permission__when_sow_add(TestCase):

    def setUp(self):
        # act
        self.test = Model(auth_user=2,scheme_of_work_id=11, 
            scheme_of_work_permission=SCHEMEOFWORK.ADD)
    ...
    def test_check__add_returns_true(self):
        # asser
        self.assertTrue(self.test.check_scheme_of_work_permission(SCHEMEOFWORK.ADD))
