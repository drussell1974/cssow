...
class test_cls_keyword__from_json(TestCase):
    ...
    def test__should_have_no__validition_errors__when_valid(self):
        ...
        # act
        self.test.from_json('{"id":1, "term":"Algorithm", "definition":"A list of instructions", "published":1}', 13)
    ...
    def test__should_have__validation_errors__when_not_invalid(self):
        ...
        # act
        self.test.from_json('{"id":1, "term":"", "definition":"A list of instructions", "published":1}', 13)
