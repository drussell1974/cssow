...
class test_cls_academic_year__constructor(TestCase):
    ...
    def test_constructor_default(self):
        ...
        self.test = AcademicYearModel(2020, start_date, end_date, is_from_db=False)

        # assert
        self.assertEqual("2020-09-01", self.test.start)
        self.assertEqual("2021-08-30", self.test.end)
    ...
    def test_constructor_set_valid_values(self):
        ...
        # assert
        self.assertEqual(2020, self.test.id)
        self.assertEqual("2020-09-01", self.test.start)
        self.assertEqual("2021-08-30", self.test.end)
        self.assertEqual("2020/2021", self.test.display)
