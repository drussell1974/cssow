...
class uitest_schemeofwork_lessonks123pathway_select_not_found(UITestCase):
    ...
    def test_page_should_redirect_to_login_page__if_scheme_of_work_id__does_not_exist(self):
        # act        
        self.do_log_in(f"/institute/{self.test_institute_id}/department/{self.test_department_id}/schemesofwork/{999999}/lessons/{self.test_lesson_id}/pathways/select")
