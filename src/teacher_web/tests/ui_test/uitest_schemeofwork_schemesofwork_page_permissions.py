...
class uitest_schemeofwork_schemesofwork_page_permission(UITestCase):
    ...
    def test_page__edit_should_redirect_to_login_when_with_permission_error_when_public_user(self):
        # test
        self.try_log_out(f"/schemesofwork/{self.test_scheme_of_work_id}/lessons/{self.test_lesson_id}")
        
        # assert
        self.assertCustomPermissionDenied(h1="PermissionError at /schemesofwork/11/lessons/220")
