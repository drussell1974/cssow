...
class uitest_schemeofwork_keyword_lesson_edit_not_found(UITestCase):
    ...
    def test_page_should_redirect_to_404__if_keyword_id__is_not_part_of_lesson(self):
        ...
        # assert
        self.assertCustom404("item (131, 11) does not exist, is currrently unavailable or you do not have permission.")
