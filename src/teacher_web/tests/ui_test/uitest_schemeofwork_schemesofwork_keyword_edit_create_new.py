...
class uitest_schemeofwork_schemesofwork_keyword_edit_create_new(UITestCase):
    ...
    def setUp(self):
        ...
        # setup
        self.do_log_in(self.root_uri + "/schemesofwork/{}/keywords/new".format(self.test_scheme_of_work_id, self.test_lesson_id))
        self.wait(2)
