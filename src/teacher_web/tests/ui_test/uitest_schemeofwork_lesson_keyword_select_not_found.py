...
class uitest_schemeofwork_lesson_keyword_select_not_found(UITestCase):
    ...
    def test_page_should_redirect_to_404__if_scheme_of_work_id__does_not_exist(self):
        # act        
        self.do_log_in(self.root_uri + "/schemesofwork/{}/lessons/{}/keywords/select".format(999999, self.test_lesson_id))
    ...
    def test_page_should_redirect_to_404__if_lesson_id__does_not_exist(self):
        # act        
        self.do_log_in(self.root_uri + "/schemesofwork/{}/lessons/{}/keywords/select".format(self.test_scheme_of_work_id, 999999, self.test_keyword_id))
