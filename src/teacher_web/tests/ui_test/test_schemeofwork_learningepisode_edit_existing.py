...
class test_schemeofwork_lesson_edit_existing(UITestCase):

    test_context = WebBrowserContext()

    def setUp(self):
        # setup
        self.try_log_in("http://dev.computersciencesow.net:8000/schemeofwork/lesson/edit?id={lesson_id}&scheme_of_work_id={scheme_of_work_id}&_next=%2Fschemeofwork%2Flesson%2Findex%2F{scheme_of_work_id}".format(lesson_id=self.test_lesson_id, scheme_of_work_id=self.test_scheme_of_work_id))
