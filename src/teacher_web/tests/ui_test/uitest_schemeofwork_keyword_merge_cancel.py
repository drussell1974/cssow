...
class uitest_schemeofwork_keyword_merge_cancel(UITestCase):
    ...
    def setUp(self):
        ...
        self.do_log_in(self.root_uri + "/schemesofwork/{}/keywords/{}/merge".format(self.test_scheme_of_work_id, self.test_keyword_id))
        self.wait(s=2)
