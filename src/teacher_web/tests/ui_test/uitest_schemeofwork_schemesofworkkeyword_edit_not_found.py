...
class uitest_schemeofwork_schemesofworkkeyword_edit_not_found(UITestCase):
    ...
    def test_page_should_redirect_to_500_permission_denied__if_scheme_of_work_id__does_not_exist(self):
        # act        
        self.do_log_in(self.root_uri + f"/institute/{self.test_institute_id}/department/{self.test_department_id}/schemesofwork/{}/keywords/{}/edit".format(999999, self.test_keyword_id))
    ...
    def test_page_should_redirect_to_404__if_keyword_id__does_not_exist(self):
        # act        
        self.do_log_in(self.root_uri + f"/institute/{self.test_institute_id}/department/{self.test_department_id}/schemesofwork/{}/keywords/{}/edit".format(self.test_scheme_of_work_id, 999999))
