...
class uitest_schemeofwork_keyword_lesson_index__search_term(UITestCase):

    test_context = WebBrowserContext()

    def setUp(self):
        # set up
        self.test_path = "/schemesofwork/{}/lessons/{}/keywords".format(self.test_scheme_of_work_id, self.test_lesson_id)
