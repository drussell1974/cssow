...
class test_db__get_number_of_lessons(TestCase):
    ...
    def test__should_call__select__with_exception(self, mock_auth_user):
        ...
        with patch.object(ExecHelper, 'select', side_effect=expected_exception):
            ...
            with self.assertRaises(KeyError):
                SchemeOfWorkModel.get_number_of_contents(self.fake_db, 101, mock_auth_user)
    ...
    def test__should_call__select__return_no_items(self, mock_auth_user):
        ...
        with patch.object(ExecHelper, 'select', return_value=expected_result):
            ...
            actual_result = SchemeOfWorkModel.get_number_of_contents(self.fake_db, 101, mock_auth_user)
            
            # assert

            ExecHelper.select.assert_called_with(self.fake_db,
                'scheme_of_work__get_number_of_contents'
    ...
    def test__should_call__select__return_single_item(self, mock_auth_user):
        ...
        with patch.object(ExecHelper, 'select', return_value=expected_result):
            ...
            actual_result = SchemeOfWorkModel.get_number_of_contents(self.fake_db, 6, mock_auth_user)
