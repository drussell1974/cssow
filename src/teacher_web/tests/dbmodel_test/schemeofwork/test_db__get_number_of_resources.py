...
get_number_of_resources = SchemeOfWorkModel.get_number_of_resources


@patch("shared.models.core.context", return_value=fake_ctx_model())
class test_db__get_number_of_resources(TestCase):
    ...
    def test__should_call__select__return_no_items(self, mock_auth_user):
        ...
        with patch.object(ExecHelper, 'select', return_value=expected_result):
            ...
            actual_result = get_number_of_resources(self.fake_db, 101, mock_auth_user)
    ...
    def test__should_call__select__return_single_item(self, mock_auth_user):
        ...
        with patch.object(ExecHelper, 'select', return_value=expected_result):
            ...
            actual_result = get_number_of_resources(self.fake_db, 6, mock_auth_user)
