...
class test_db__get_latest_schemes_of_work(TestCase):
    ...
    def test__should_call__select__return_single_item(self, mock_ctx):
        # arrange
        expected_result = [(6, "Lorem", "ipsum dolor sit amet.", 4, "AQA", 4, "KS4", "2020-07-21 17:09:34", 1, "test_user", 1, 1271176, "Computer Science", 3, 12711761271176, "Lorem Ipsum", 3, 9)]
        ...
        with patch.object(ExecHelper, 'select', return_value=expected_result):
            ...
            self.assertEqual(3, rows[0].department.topic_id)
    ...
    def test__should_call__select__return_multiple_item(self, mock_ctx):
        ...
        expected_result = [
            (6, "Lorem", "ipsum dolor sit amet.", 4, "AQA", 4, "KS4", "2020-07-21 17:09:34", 1, "test_user", 1, 1271176, "Computer Science", 3, 12711761271176, "Lorem Ipsum",1, 10),
            (7, "Phasellus", "ultricies orci sed tempus.", 4, "AQA", 4, "KS4", "2020-07-21 17:09:34", 1, "test_user", 1, 1271176, "Computer Science", 3, 12711761271176, "Lorem Ipsum",1, 10),
            (8, "Nulla", "Tristique pharetra nisi. Sed", 4, "AQA", 4, "KS4", "2020-07-21 17:09:34", 1, "test_user", 1, 1271176, "Computer Science", 3, 12711761271176, "Lorem Ipsum",2, 10)]
        ...
        with patch.object(ExecHelper, 'select', return_value=expected_result):
            ...
            self.assertEqual(3, rows[2].department.topic_id)
