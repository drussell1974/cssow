...
class test_db__save(TestCase):
    ...
    def test_should_raise_exception(self, mock_auth_user):
        ...
        model = Model(0, "", lesson_id = 12, scheme_of_work_id = 11, auth_user=mock_auth_user)
    ...
    def test_should_call__update_with_exception(self, mock_auth_user):
        ...
        model = Model(1, "", lesson_id = 12, scheme_of_work_id = 11, auth_user=mock_auth_user)
    ...
    def test_should_call__update_with__is_new__false(self, mock_auth_user):
         # arrange
        model = Model(1, "ZYXWVU", lesson_id = 12, scheme_of_work_id = 11, auth_user=mock_auth_user)
    ...
    def test_should_call__insert_insert__when__is_new__true(self, mock_auth_user):
        ...
        model = Model(0, class_code="MNOPQR", lesson_id = 12, scheme_of_work_id = 11, auth_user=mock_auth_user)
    ...
    def test_should_call__delete__when__is_new__false__and__published_is_2(self, mock_auth_user):
        ...
        model = Model(101, class_code="MNOPQR", lesson_id = 12, scheme_of_work_id = 11, auth_user=mock_auth_user)
