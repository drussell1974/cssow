...
class test_db_learning_objective__get_pathway_objectives(TestCase):
    ...
    def test__should_call_execSql_return_no_items(self):
        ...
        with patch.object(ExecHelper, 'execSql', return_value=expected_result):
            # act
            test_keywords = ","
            result = Model.get_all_pathway_objectives(self.fake_db, key_stage_id = 0, key_words=test_keywords)
    ...
    def test__should_call_execSql_return_single_item(self):
        ...
        with patch.object(ExecHelper, 'execSql', return_value=expected_result):
            ...
            result = Model.get_all_pathway_objectives(self.fake_db, key_stage_id = 5, key_words=test_keywords)
