...
from app.lesson_pathways.views import select #, index, new, edit, delete_item, save, publish_item, delete_unpublished

# Create your tests here.
class test_app_route_lesson_pathways_page(TestCase):
    ...
    def test__pathways_index__url_resolves_to_index(self):
        ...
        self.assertEqual("lesson_pathways.index", url.url_name)
        self.assertEqual(url.func, select) #index)

    
    def test__pathways_index__url_resolves_to_index__reverse(self):
        url = reverse("lesson_pathways.index", args=[12711761271176, 1271176, 127, 32])
    ...
    def test__pathways_delete_item__url_resolves_to_delete(self):
        ...
        self.assertEqual("lesson_pathways.delete_item", url.url_name)
        self.assertEqual(url.func, delete_item)
        

    def test__pathways_delete_item__url_resolves_to_delete__reverse(self):
        url = reverse("lesson_pathways.delete_item", args=[12711761271176, 1271176, 127, 32, 1])
    ...
    def test__pathways_edit__url_resolves_to_edit(self):
        ...
        self.assertEqual("lesson_pathways.edit", url.url_name)
        self.assertEqual(url.func, edit)

    
    def test__pathways_edit__url_resolves_to_edit__reverse(self):
        url = reverse("lesson_pathways.edit", args=[12711761271176, 1271176, 127, 32, 1])
    ...
    def test__pathways_select__url_resolves_to_select(self):
        ...
        self.assertEqual("lesson_pathways.select", url.url_name)
        self.assertEqual(url.func, select)

    
    def test__pathways_select__url_resolves_to_select__reverse(self):
        url = reverse("lesson_pathways.select", args=[12711761271176, 1271176, 127, 32])
    ...
    def test__pathways_save__url_resolves_to_save(self):    
        ...
        self.assertEqual("lesson_pathways.save", url.url_name)
        self.assertEqual(url.func, save)

    
    def test__pathways_save__url_resolves_to_save__reverse(self):
        url = reverse("lesson_pathways.save", args=[12711761271176, 1271176, 127, 32, 99])
    ...
    def test__pathways_delete_unpublished__url_resolves_to_delete_unpublished(self):
        ...
        self.assertEqual("lesson_pathways.delete_unpublished", url.url_name)
    ...
    def test__pathways_delete_unpublished__url_resolves_to_delete_unpublished__reverse(self):
        url = reverse("lesson_pathways.delete_unpublished", args=[12711761271176, 1271176, 11, 32])
