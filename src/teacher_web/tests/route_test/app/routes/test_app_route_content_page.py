...
class test_app_route_content_page(TestCase):
    ...
    def test__content_delete_unpublished__url_resolves_to_edit(self):
        url = resolve("/schemesofwork/127/curriculum-content/delete_unpublished")
    ...
    def test__content_delete_unpublished__url_resolves_to_edit__reverse(self):
        url = reverse("content.delete_unpublished", args=[127])
        self.assertEqual("/schemesofwork/127/curriculum-content/delete_unpublished", url)