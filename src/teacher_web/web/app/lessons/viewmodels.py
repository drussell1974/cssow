...
class LessonIndexViewModel(BaseViewModel):
    ...
    def view(self, request):
        ...
        return ViewModel(request, self.scheme_of_work_name, self.scheme_of_work_name, "Lessons", ctx=self.auth_user, data=data, error_message=self.error_message, alert_message=self.alert_message)
