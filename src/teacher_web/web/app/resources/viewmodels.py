...
class ResourceIndexViewModel(BaseViewModel):
    ...
    def view(self, request):
        ...
        return ViewModel(request, self.lesson.title, self.lesson.title, "Lesson", content_heading="Resources", ctx=self.auth_user, data=data, active_model=self.lesson, error_message=self.error_message)
...
class ResourceGetModelViewModel(BaseViewModel):
    ...
    def view(self, request):
        ...
        return ViewModel(request, self.lesson.title, self.lesson.title, "Lesson", content_heading="Resource", ctx=self.auth_user, data=data, active_model=self.lesson)
