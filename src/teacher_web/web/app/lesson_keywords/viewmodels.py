...
class LessonKeywordIndexViewModel(BaseViewModel):
    ...
    def view(self):
        ...
        return ViewModel(self.lesson.title, self.lesson.title, self.lesson.summary, ctx=None, data=data, active_model=self.lesson, error_message=self.error_message)
...
class LessonKeywordSelectViewModel(BaseViewModel):
    ...
    def view(self, request):      
        ...
        return ViewModel(self.model.title, self.model.title, "Select keywords for {}".format(self.model.title), ctx=None, data=data, active_model=self.model, error_message=self.error_message)
