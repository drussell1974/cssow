...
class LessonKS123PathwaySelectViewModel(BaseViewModel):
    ...
    def view(self, request):      
        ...
        return ViewModel(request, self.model.title, self.model.title, "Lesson", content_heading="Pathway - prior learning", ctx=self.auth_user, data=data, active_model=self.model, error_message=self.error_message, wizard=self.wizard)
