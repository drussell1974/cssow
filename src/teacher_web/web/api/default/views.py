...
class KeywordsListViewSet(APIView):
    ...
    def get (self, request, scheme_of_work_id):
        ...
        keywords = KeywordGetOptionsListViewModel(db=db, scheme_of_work_id=scheme_of_work_id, auth_user=auth_user_model(db, request))
...
class RelatedTopicsListViewSet(APIView):
    ...
    def get (self, request, topic_id):
        ...
        topics_view = TopicGetOptionsListViewModel(db=db, topic_id=topic_id, auth_user=auth_user_model(db, request))
