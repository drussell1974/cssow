...
class ViewModel:
    ...
    def __init__(self, request, page_prefix, main_heading, sub_heading, ctx, data = None, active_model = None, error_message = "", stack_trace = "", alert_message = "", delete_dialog_message = "", cancel_dialog_message = "", wizard = None):
        """ Create View Model """
        self.data = data
        self.ctx = ctx
