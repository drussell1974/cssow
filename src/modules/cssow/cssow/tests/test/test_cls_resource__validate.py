...
class test_cls_resource_validate__title(TestCase):
    ...
    def setUp(self):
        self.test = ResourceModel(1, lesson_id = 1002, type_id = 3, type_name = "Video", title = "title here!", publisher="YouTube", scheme_of_work_id = 0)
...
class test_cls_resource_validate__page_note(TestCase):
    ...
    def setUp(self):
        self.test = ResourceModel(1, lesson_id = 12, type_id = 3, type_name = "Video", title = "title here!", publisher="YouTube", scheme_of_work_id = 0)
...
class test_cls_resource_validate__page_uri(TestCase):
    ...
    def setUp(self):
        self.test = ResourceModel(1, lesson_id = 101, type_id = 2, type_name = "Website", title = "title here!", publisher = "Medium.com", scheme_of_work_id = 0)
...
class test_cls_resource_validate__publisher(TestCase):
    ...
    def setUp(self):
        self.test = ResourceModel(1, lesson_id = 301, type_id = 6, type_name = "Book", title = "title here!", publisher = "penguin", scheme_of_work_id = 0)
    ...
    def test_min__valid_extreme(self):
        ...
        self.test.publisher = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse vehicula imperdiet quam. Curabitur lectus augue, vehicula \
            ...
            pretium volutpat et eget orci. Sed aliquet, dui non tempus porta, justo ut."
        # 500 characters
    ...
    def test_max__invalid_extreme(self):
        # setup
        self.test.publisher = 2101 # too far out of possible range
