...
class test_pager__render_html(TestCase):
    ...
    def test_1_page_group_for_7_record(self):
        # set up
        self.test = Pager(page = 1, page_size = 5,data = [
    ...
    def test_2_page_groups_for_35_record(self):
        # set up
        self.test = Pager(page = 1, page_size = 5, data = [
            "Cobalt (Co)",  "Chlorine (Cl)",    "Potassium (K)",    "Tin (Sn)",         "Mercury (Pb)",
    ...
    def test_2_page_groups_with_next_for_36_records(self):
        ...
        self.assertEqual(7, self.test.end_page, "end_page not as expected")
        self.assertTrue(self.test.is_first_page_group, "is_first_page_group not as expected")
        self.assertFalse(self.test.is_last_page_group, "is_last_page_group not as expected")
        self.assertFalse(self.test.show_prev_group_of_pages, "show_prev_group_of_pages not as expected")
    ...
    def test_2_page_groups_with_previous_for_36_records(self):
        ...
        self.assertFalse(self.test.is_first_page_group, "is_first_page_group not as expected")
        self.assertTrue(self.test.is_last_page_group, "is_last_page_group not as expected")
        self.assertTrue(self.test.show_prev_group_of_pages, "show_prev_group_of_pages not as expected")
        self.assertFalse(self.test.show_next_group_of_pages, "show_next_group_of_pages not as expected")
    ...
    def _test_3_page_groups_with_previous_for_75_records(self):
        # set up
        self.test = Pager(page = 15, page_size = 5, pager_size = 3, data = [
            # group 1
            "Iron (Fe)",    "Gold (Au)",        "Carbon (C)",       "Hydroen (H)",      "Oxygen (O)",
            "Cobalt (Co)",  "Chlorine (Cl)",    "Potassium (K)",    "Tin (Sn)",         "Mercury (Pb)",
            "Arsenic (As)", "Vanadium (V)",     "Indium (In)",      "Sodium (Na)",      "Beryllium (Be)",
        ...
        self.assertEqual(75, self.test.display_records_end, "display_records_end not as expected")
        self.assertEqual("<li><a href='?page=14' class='btn'>&larr;</a></li>"\
                         "<li><a href='?page=15' class='btn'>15</a></li>", result)


    def _test_3_page_groups_with_previous_for_76_records(self):
        # set up
        self.test = Pager(page = 7, page_size = 5, pager_size = 3, data = [
            # group 1
            "Iron (Fe)",    "Gold (Au)",        "Carbon (C)",       "Hydroen (H)",      "Oxygen (O)",
            "Cobalt (Co)",  "Chlorine (Cl)",    "Potassium (K)",    "Tin (Sn)",         "Mercury (Pb)",
            "Arsenic (As)", "Vanadium (V)",     "Indium (In)",      "Sodium (Na)",      "Beryllium (Be)",
        ...
        self.assertEqual(75, self.test.display_records_end, "display_records_end not as expected")
        self.assertEqual("<li><a href='?page=14' class='btn'>&larr;</a></li>"\
                         "<li><a href='?page=15' class='btn'>15</a></li>"\
